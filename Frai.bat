...
set stat0=0
mode con cols=50 lines=20
title Free Roaming Artificial Inteligance
COLOR 1a
:start
...
set /a idx=%random% %%7
if %idx%==0 SET errorlevel=1
if %idx%==1 SET errorlevel=2
if %idx%==2 SET errorlevel=3
if %idx%==3 SET errorlevel=4
if %idx%==4 SET errorlevel=5
if %idx%==5 SET errorlevel=6
if %idx%==6 SET errorlevel=7
:lwjgl0
...
if %errorlevel%==7 goto togglemove
goto interact
:togglemove
if %stat0%==0 (
	set stat0=1
